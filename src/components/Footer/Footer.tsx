...
export const Footer: React.FC = () => {
  return (
    <footer className="footer">
        <div className="heading--h3 footer__logo">NICE👌<br/>GADGETS</div>
        ...
        <div className="footer__backtotop">
          <a href="#index" className="footer__backtotop__text text--small">Back to top</a>
          <a href="#index" className="footer__backtotop__button">
