...
import EmptyCard from '../../images/cartEmpty.png'
        ...
        <>
            {!cart.length && !isProcessing ?
                <section className='cart-page main__cart-page'>
                    ...
                    <img className='cart-empty-img' src={EmptyCard} alt="empty cart" />
